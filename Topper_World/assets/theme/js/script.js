...
(function () {
    function b(a, c) { var e = Array.from(a.querySelectorAll(c)); a.matches && a.matches(c) && e.splice(0, 0, a); return e } function h(a) { a = a.getBoundingClientRect(); var c = document.documentElement; return { top: a.top + window.pageYOffset - c.clientTop, left: a.left + window.pageXOffset - c.clientLeft } } function f(a) { return parseFloat(getComputedStyle(a, null).height.replace("px", "")) } function p(a) { return parseFloat(getComputedStyle(a, null).width.replace("px", "")) } function k(a) {
        "loading" != document.readyState ? a() : document.addEventListener("DOMContentLoaded",
            a)
    } function n(a) { (function e() { 0 > (a.style.opacity -= .1) ? a.style.display = "none" : requestAnimationFrame(e) })() } function u(a) { a.style.display = "block"; (function e() { var b = parseFloat(a.style.opacity); 1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(e)) })() } function x(a) {
        ...
        a.querySelectorAll(".carousel-item").forEach(function (a) { for (var c = a, b = 1; b < e; b++) { (c = c.nextElementSibling) || (c = a.parentNode.children[0] === a ? a.nextElementSibling : a.parentNode.children[0]); var d; if (d = c) { var f = 0; do f++; while (d = d.previousElementSibling); d = f } else d = -1; f = c.querySelector(".col-md-12").cloneNode(!0); f.classList.add("cloneditem-" + b); f.classList.add("clonedCol"); f.setAttribute("data-cloned-index", d); a.children[0].appendChild(f) } })
    } function F(a) {
        var c = "", b = a.querySelector("svg linearGradient");
        if (b) { c = []; b = Array.from(b.children); for (var d = 0; d < b.length; d++)c.push('"' + b[d].getAttribute("stop-color") + '"'); c = '"lineargradient": [' + c + "],"; Array.from(a.querySelectorAll("svg")).some(function (a) { return a.classList.contains("svg-gradient") }) || a.querySelectorAll("svg").forEach(function (a) { a.classList.add("svg-gradient") }) } return c
    } function z(a, c, b) {
    ...
    } var g, m, v = "function" == typeof jQuery; v && (g = jQuery); g ? m = g("html").hasClass("is-builder") : m = document.querySelector("html").classList.contains("is-builder"); Element.prototype.parents = function (a) { for (var c = [], b = this, d = void 0 !== a; null !== (b = b.parentElement);)b.nodeType === Node.ELEMENT_NODE && (d && !b.matches(a) || c.push(b)); return c }; Element.prototype.footerReveal = function () {
        function a() {
        ...
        var b = function (a, b, c) {
            var e; return function () {
                var l = this, d = arguments; e ?
                    clearTimeout(e) : c && a.apply(l, d); e = setTimeout(function () { c || a.apply(l, d); e = null }, b || 100)
            }
        }; window[a] = function (c) { var e = new CustomEvent(a); return c ? this.addEventListener("resize", b(c)) : this.dispatchEvent(e) }
                        ...
                        e = a.querySelector(".mbr-background-video-preview") || document.createElement("div"); e.classList.add("mbr-background-video-preview"); e.style.display = "none"; e.style.backgroundSize = "cover"; e.style.backgroundPosition = "center"; a.querySelector(".mbr-background-video-preview") || a.childNodes[0].before(e); if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3]))) if (c && /youtu\.?be/g.test(c[3])) {
                            c[6] = c[6].replace("shorts", "embed"); b = "http" + ("https:" === location.protocol ? "s" : "") + ":"; b += "//img.youtube.com/vi/" + c[6] +
                                "/maxresdefault.jpg"; var l = new Image; l.onload = function () {
                                    ...
                                    d.style.width = "100%"; d.style.height = "100%"; d.parentNode.style.overflow = "hidden"; d.style.transform = "scale(1.2)"; b.load(c[6], !0); b.play(); b.loadPlaylist(); b.setLoop(!0); b.mute(); f = window.outerWidth; d = window.outerHeight; q = b._opts.width / b._opts.height; r = Math.ceil(f / q); r < d && (r = d, f = Math.ceil(r * q)); b.setSize(f, r)
        ...
        window.addEventListener("smartresize", function () { document.querySelectorAll(".mbr-section--16by9").forEach(a) }); if (v) g(document).on("add.cards changeParameter.cards", function (c) { var d = b(c.target, ".mbr-section--16by9"); d.length ? d.forEach(function (b) { b.setAttribute("data-16by9", "true"); a(b) }) : b(c.target, "[data-16by9]").forEach(function (a) { a.styles.height = ""; a.removeAttribute("data-16by9") }) }); if ("undefined" !== typeof jarallax && !x()) {
            window.addEventListener("update.parallax", function (a) {
                ...
                if (!v) return; g(document).on("add.cards", function (a) { c(a.target); g(window).trigger("update.parallax") }); g(document).on("changeParameter.cards", function (a, b, d, e) {
        ...
        } var d, l, C = 0, t = null, k = !x(); window.addEventListener("scroll", function () {
            l && clearTimeout(l); var a = document.documentElement.scrollTop, b = a <= C || k; C = a; if (t) {
                var c = a > t.breakPoint; b ? c != t.fixed && (k ? (t.fixed =
                    c, t.elm.classList.toggle("is-fixed")) : l = setTimeout(function () { t.fixed = c; t.elm.classList.toggle("is-fixed") }, 40)) : (t.fixed = !1, t.elm.classList.remove("is-fixed"))
            }
        }); if (v) g(document).on("add.cards delete.cards", function (a) { d && clearTimeout(d); d = setTimeout(function () { t && (t.fixed = !1, t.elm.classList.remove("is-fixed")); var a = document.querySelector(".mbr-fixed-top"); a && (t = { breakPoint: h(a).top + 3 * f(a), fixed: !1, elm: a }, a.dispatchEvent(new CustomEvent("scroll"))) }, 650) }); window.smartresize(function () {
        ...
        }); if (v) g(document).on("add.cards", function (a) { document.querySelector("html").classList.contains("mbr-site-loaded") && b(a.target, "iframe").length && window.dispatchEvent(new CustomEvent("resize")) }); if (m) { if (!v) return; g(document).on("add.cards", function (a) { e(a.target) }) } else e(document.body); if (m) g(document).on("changeParameter.cards", function (a, b, c, d) {
            if ("bg" === b) switch (d) {
                ...
                var b = a.target; if (!b.parents().some(function (a) { a.classList.contains("carousel") })) {
                    do if (b.hash) {
                        var c = /#bottom|#top/g.test(b.hash); document.querySelectorAll(c ? "body" : b.hash).forEach(function (c) {
                            a.preventDefault(); var d = document.querySelector(".navbar-fixed-top");
                            d = "#bottom" == b.hash ? f(c) - window.innerHeight : h(c).top - (d ? 60 : 0); c.classList.contains("panel-collapse") || c.classList.contains("tab-pane") || b.classList.contains("carousel-control") || b.parents(".carousel-controls").length || window.scrollTo({ top: d, left: 0, behavior: "smooth" })
                        }); break
            ...
            function b() {
                c.style.width = ""; c.style.maxWidth = ""; c.style.marginLeft = ""; if (l && e) {
                    var b = l / e; a.style.position = "absolute";
                    a.style.top = "0"; a.style.left = "0"; a.style.right = "0"; a.style.bottom = "0"; var g = f(d) / p(d); g > b && (b = 100 * (g - b) / b, c.style.width = b + 100 + "%", c.style.maxWidth = b + 100 + "%", c.style.marginLeft = -b / 2 + "%")
                }
            } var c = a.querySelector("img"), d = a.parentNode, e = c.width, l = c.height; c.addEventListener("load", function () { e = c.width; l = c.height; b() }, { once: !0 }); window.addEventListener("resize", b); b()
        })
    }); if (!m) {
        ...
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            var a = document.querySelector("#scrollToTop"); a.style.display = "none"; window.addEventListener("scroll", function () {
            ...
            }); a.addEventListener("click", function () { window.scrollTo({ top: 0, left: 0, behavior: "smooth" }); return !1 })
        }
    }); if (!m) {
        var w = document.querySelector(".mbr-arrow"); w && w.addEventListener("click", function (a) {
            a = a.target.closest("section").nextElementSibling; a.classList.contains("engine") && (a = a.closest("section").nextElementSibling);
            window.scrollTo(0, h(a).top)
        })
    } document.querySelectorAll("nav.navbar").length && (w = f(document.querySelector("nav.navbar")), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = w + "px")); if (!m && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) g(document).on("add.cards", function (a) {
        var b = a.target; b.classList.contains("mbr-fullscreen") && (a = function () {
            b.style.height = "auto"; b.offsetHeight <=
                window.innerHeight && (b.style.height = "1px")
        }, window.addEventListener("load", a), window.addEventListener("resize", a)); if (b.classList.contains("mbr-slider") || b.classList.contains("mbr-gallery")) b.querySelectorAll(".carousel-indicators").forEach(function (a) { a.classList.add("ie-fix"); a.querySelectorAll("li").forEach(function (a) { a.style.display = "inline-block"; a.style.width = "30px" }) }), b.classList.contains("mbr-slider") && b.querySelectorAll(".full-screen .slider-fullscreen-image").forEach(function (a) {
            a.style.height =
                "1px"
        })
    }); k(function () {
        if (!m) {
            var a = function (a) { a.target && ("VIDEO" == a.target.tagName ? (a.preventDefault(), a.stopPropagation()) : b(a.target)) }, b = function (b) {
                var c = b.parents("section")[0].querySelector("iframe"), e = c.getAttribute("src"); b.parents("section").forEach(function (a) { a.style.zIndex = "5000" }); if (e) { if (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"), -1 !== e.indexOf("vimeo")) { var f = new Vimeo.Player(c); f.play() } } else {
        ...
        } document.querySelectorAll('input[type="range"]').forEach(function (a) { a.addEventListener("change", function (a) { a.target.parents(".form-group").forEach(function (b) { b.querySelector(".value").innerHTML = a.target.value }) }) }); if (m) g(document).on("add.cards changeParameter.cards", function (a, b) { "undefined" !== typeof CircularProgressBar && new CircularProgressBar("pie_progress"); b ? G(a.target, b) : a.target.querySelectorAll(".pie_progress").length && a.target.querySelectorAll(".pie_progress").forEach(function (a) { D(a) }) });
...
})(); document.getElementsByTagName("body")[0].setAttribute("style", "z-index: 0"); !function () { try { document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) { } if (!document.getElementById("top-1")) { var a = document.createElement("section"); a.id = "top-1"; a.style = "display: none"; a.innerHTML = '<a href="https://mobirise.com/website-builder/author.html">author website builder</a> Mobirise v5.9.6 <a href="https://mobirise.com/drag-drop-website-builder.html">drag & drop website builder</a>'; document.body.insertBefore(a, document.body.childNodes[0]) } }();
